function Test_Cases = Get_Test_Cases()
    ...
    % Add mode-specific fields (empty for Evolution)
    ...
    tc.Parameters = Parameters();
    tc.Parameters.Nx = [];  % Not used in Convergence mode
    tc.Parameters.Ny = [];   % Not used in Convergence mode
    ...
    tc.Parameters.dt = 0.001;
    tc.Parameters.snap_times = [0, 0.05];
    tc.Parameters.mesh_sizes = [];  % Not used in ParameterSweep mode
