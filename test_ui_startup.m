...
addpath(fullfile(script_dir, 'Scripts', 'Main'));
addpath(fullfile(script_dir, 'Scripts', 'Methods'));
addpath(fullfile(script_dir, 'Scripts', 'Sustainability'));
addpath(fullfile(script_dir, 'Scripts', 'Visuals'));
...
critical_files = {
    ...
    'Scripts/Main/Analysis.m', 'Main Driver'
    'Scripts/Methods/Finite_Difference_Analysis.m', 'FD Solver'
    'Scripts/Sustainability/EnergySustainabilityAnalyzer.m', 'Energy Analyzer'
    'Scripts/Visuals/create_live_monitor_dashboard.m', 'Live Monitor'
