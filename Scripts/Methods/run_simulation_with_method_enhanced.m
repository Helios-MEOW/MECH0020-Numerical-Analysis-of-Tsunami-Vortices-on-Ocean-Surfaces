function [fig_handle, analysis] = run_simulation_with_method_enhanced(Parameters)
% RUN_SIMULATION_WITH_METHOD_ENHANCED Method dispatcher with comprehensive metrics
%
...
%
% Usage:
%   [fig_handle, analysis] = run_simulation_with_method_enhanced(Parameters)
%
% Input:
...
%   analysis   - struct with comprehensive metrics listed above
    ...
    % Simply call the dispatcher (which now has unified metrics)
