...
%   https://www.mathworks.com/help/matlab/ref/matlab.ui.container.gridlayout-properties.html
    ...
    cfg.ui_text.window = struct( ...
        'main_title', 'Numerical Simulation of Tsunami Vorticies User Interface', ...
        'menu_title', 'Numerical Simulation of Tsunami Vorticies User Interface');
    ...
    cfg.ui_text.config.root = struct( ...
        ...
        'right_panel_title', 'Initial Condition and Readiness');

    cfg.ui_text.config.method = struct( ...
        'panel_title', 'Solution Method and Analysis Mode', ...
        'method_label', 'Method', ...
        'mode_label', 'Mode', ...
